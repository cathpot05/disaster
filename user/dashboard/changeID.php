...
$row = mysqli_fetch_array($result);
	...
	<form class="form-horizontal" action="editStudent.php?id=<?php echo $id; ?>" method=post >
		...
		<input type="text" required class="form-control" name="emailTxt" placeholder="Email Address " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Email Address '" value="<?php echo $row['email']; ?>"><br>
    ...
    $row = mysqli_fetch_array($result);
    ?>
    <form class="form-horizontal" name="changePassForm" action="changePassStudent.php?id=<?php echo $id; ?>" method=post id="form_changepass" onsubmit="return validateForm()">
